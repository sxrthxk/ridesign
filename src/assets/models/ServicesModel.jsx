...
const ServicesObject = [
...

  {
    ...
    content: "A marketing campaign creation is a concentrated marketing effort. It’s usually focused on a singular, consistent marketing message spread across several channels and is meant to achieve a specific business goal.    For the best examples of marketing campaigns, just switch on your TV during Superbowl. Whatever ads you see are usually part of a new, splashy marketing campaign to achieve different goals for the brand.",
    image: campaigncreation,
    bgImage: campaigncreationbg,
  },
  {
    key: 8,
    id: "web-dev",
